							...
							<div class="col-lg-12 col-xl-6 order-lg-3 order-xl-2 tab-content">
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="border-0 flex-1 position-relative shadow-top">
                                                <div class="pt-2 pb-1 pr-0 pl-0 rounded-0 position-relative" tabindex="-1">
                                                    <span class="profile-image rounded-circle d-block position-absolute" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-admin.png";?>'); background-size: cover;"></span>
                                                    <div class="pl-5 ml-5">
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <div class="d-flex flex-row w-100 py-4">
                                                <div class="d-inline-block align-middle status status-sm status-success mr-3">
                                                    <span class="profile-image profile-image-md rounded-circle d-block mt-1" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-c.png";?>'); background-size: cover;"></span>
                                                </div>
                                            ...
                                            <div class="d-flex flex-row w-100 py-4">
                                                ...
                                                <div class="mb-0 flex-1 text-dark">
                                                    ...
                                                    <div class="pl-0 d-flex flex-row w-100 pb-0 pt-4">
                                                        <div class="d-inline-block align-middle status status-sm status-success mr-3">
                                                            <span class="profile-image profile-image-md rounded-circle d-block mt-1" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-e.png";?>'); background-size: cover;"></span>
                                                        </div>
                                                        <div class="mb-0 flex-1 text-dark">
                                                            <div class="d-flex">
                                                                <a href="javascript:void(0);" class="text-dark fw-500">
                                ...
                                <div class="card mb-g">
                                    <div class="card-body pb-0 px-4">
                                        <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                                            <div class="d-inline-block align-middle status status-success mr-3">
                                                <span class="profile-image rounded-circle d-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-admin.png";?>'); background-size: cover;"></span>
                                            </div>
                                            <h5 class="mb-0 flex-1 text-dark fw-500">
                                                Dr. Codex Lantern
                                                <small class="m-0 l-h-n">
                                        ...
                                        <div class="pb-3 pt-2 border-top-0 border-left-0 border-right-0 text-muted">
                                            ...
                                            <img src="<?="http://".ROOT_APP_URL."/img/demo/gallery/46.jpg";?>" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-flex align-items-center demo-h-spacing py-3">
                                            <a href="javascript:void(0);" class="d-inline-flex align-items-center text-dark">
                                    ...
                                    <div class="card-body py-0 px-4 border-faded border-right-0 border-bottom-0 border-left-0">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <div class="d-flex flex-row w-100 py-4">
                                                <div class="d-inline-block align-middle status status-sm status-success mr-3">
                                                    <span class="profile-image profile-image-md rounded-circle d-block mt-1" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-h.png";?>'); background-size: cover;"></span>
                                                </div>
                                                <div class="mb-0 flex-1 text-dark">
                                                    <div class="d-flex">
                                                        <a href="javascript:void(0);" class="text-dark fw-500">
                                        ...
                                        <div class="pb-3 pt-2 border-top-0 border-left-0 border-right-0 text-muted">
                                            ...
                                            <div class="d-flex overflow-hidden rounded w-100 border">
                                                <div class="row no-gutters">
                                                    <div class="col-2 col-sm-3" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/profile/article-healthyfood.png";?>'); background-size: cover;"></div>
                                                    <div class="col">
