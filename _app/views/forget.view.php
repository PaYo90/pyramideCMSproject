                ...
                <div class="page-content-wrapper bg-transparent m-0">
                    ...
                    <div class="flex-1" style="background: url(img/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
                        <div class="container py-4 py-lg-5 my-lg-5 px-4 px-sm-0">
                            <div class="row">
                                ...
                                <div class="col-xl-6 ml-auto mr-auto">
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form id="js-login" novalidate="" action="<?="http://".ROOT_APP_URL."/forgot";?>" method="post">
											<?php Aplikacja\Messages::flashMessages(); ?>
                                            <div class="form-group">
                                                <label class="form-label" for="lostaccount">Your username or email</label>
                                                <input type="text" id="lostaccount" minlenght="2" maxlength="64" class="form-control" placeholder="Recovery email or Username" name="emailorusername" required>
							...
							<div class="text-center"><a href="<?="http://".ROOT_APP_URL."/loginForm";?>" >Wroc do logowania</a></div>
                        </div>
