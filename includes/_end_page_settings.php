        ...
        <script src="<?="http://".ROOT_APP_URL."/js/vendors.bundle.js";?>"></script>
        <script src="<?="http://".ROOT_APP_URL."/js/app.bundle.js";?>"></script>
        ...
        <script src="<?="http://".ROOT_APP_URL."/js/dependency/moment/moment.js";?>"></script>
        <script src="<?="http://".ROOT_APP_URL."/js/miscellaneous/fullcalendar/fullcalendar.bundle.js";?>"></script>
        <script src="<?="http://".ROOT_APP_URL."/js/statistics/sparkline/sparkline.bundle.js";?>"></script>
        <script src="<?="http://".ROOT_APP_URL."/js/statistics/easypiechart/easypiechart.bundle.js";?>"></script>
        <script src="<?="http://".ROOT_APP_URL."/js/statistics/flot/flot.bundle.js";?>"></script>
        <script src="<?="http://".ROOT_APP_URL."/js/miscellaneous/jqvmap/jqvmap.bundle.js";?>"></script>
		<script src="<?="http://".ROOT_APP_URL."/js/datagrid/datatables/datatables.bundle.js";?>"></script>
		<script src="<?="http://".ROOT_APP_URL."/js/statistics/peity/peity.bundle.js";?>"></script>
        <script>
