                                                    ...
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-c.png";?>')"></span>
                                                            </span>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-admin.png";?>" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
