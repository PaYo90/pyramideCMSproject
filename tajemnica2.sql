...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2019 at 08:11 PM
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `imie`, `nazwisko`, `miasto`, `country`, `date_created`, `RoleID`, `newsletter`, `is_banned`, `is_activated`) VALUES
(28, 'Skorpiono', 'skorpss@gmail.com', '$2y$12$lDjSV/bYYcjZLkJyEW3poeE0qLwfOvoH2i06MY2KsqCJAGWiooe6e', 'Szymon', 'Zachariasz', NULL, NULL, '2019-10-01 18:33:09', 1, 'yes', b'0', b'1'),
...
(31, 'Skorpiono4', 'skorpss4@gmail.com', '$2y$12$QKPxpcd5hIEcSUGV08illu6Zjt/JpRiL89rRacsqxDbmOfvF.fI7q', 'Krystyna', 'Zobczynska', NULL, NULL, '2019-10-04 16:19:07', 0, 'no', b'0', b'1');
