...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="themes/smartadmin/css/page-login.css">
    </head>
    <body>
        <div class="blankpage-form-field">
            <div class="page-logo m-0 w-100 align-items-center justify-content-center rounded border-bottom-left-radius-0 border-bottom-right-radius-0 px-4">
				
				<!--wstawic tu linka na maina-->
            ...
            <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
                ...
                <form action="http://<?=ROOT_APP_URL;?>/login" method="post">
                    <div class="form-group">
                        <label class="form-label" for="username">Username</label>
                        <input type="text" name="username" minlenght="2" maxlength="32" id="username" class="form-control" placeholder="" value="">
                        <span class="help-block">
                            Your unique username to <?=SITE_NAME;?>
                        </span>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="password">Password</label>
                        <input type="password" name="password" minlenght="2" maxlength="32" id="password" class="form-control" placeholder="" value="">
                        <span class="help-block">
                            Your password
                        </span>
                    </div>
                    <div class="form-group text-left">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="rememberme"> Remember me for the next 7 days</label>
                        </div>
                    </div>
            ...
            <div class="blankpage-footer text-center">
                <a href="http://<?=ROOT_APP_URL;?>/forgetForm"><strong>Recover Password</strong></a> | <a href="http://<?=ROOT_APP_URL;?>/registerForm"><strong>Register Account</strong></a>
            </div>
        </div>
