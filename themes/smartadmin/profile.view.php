                            ...
                            <div class="col-lg-6 col-xl-3 order-lg-1 order-xl-1">
                                    ...
                                    <div class="row no-gutters row-grid">
                                        <div class="col-12">
                                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                                <img src="http://{{ROOT_APP_URL}}/IMAGES/avatars/{{$row['id']}}/{{$row['username']}}_lg.{{$row['avatar']}}" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                ...
                                <div class="card mb-g">
                                    <div class="row row-grid no-gutters">
                                        ...
                                        <?php $zdjecia = app\Gallery::profile9newestPhotos($row['id']);?>
                                        <?php $rotate = 0; ?>
                                        @FOREACH($zdjecia as $zdjecie)
                                        <div class="col-4">
                                            <?php if ($zdjecie['album_id'] != NULL){
                                                $urlsm = "http://".ROOT_APP_URL."/IMAGES/gallery/".$row['id']."/album_".$zdjecie['album_id']."/small/".$zdjecie['name'];
                                                $url = "http://".ROOT_APP_URL."/gallery/".$row['id']."/#lg=1&slide=".$rotate;
                                            }else{
                                                $urlsm = "http://".ROOT_APP_URL."/IMAGES/gallery/".$row['id']."/small/".$zdjecie['name'];
                                                $url = "http://".ROOT_APP_URL."/gallery/".$row['id']."/#lg=1&slide=".$rotate;
                                            } ?>
                                            <a href="{{$url}}" class="text-center px-3 py-4 d-flex position-relative height-10 border">
                                                <span class="position-absolute pos-top pos-left pos-right pos-bottom" style="background-image: url('{{$urlsm}}');background-size: cover;"></span>
                                            </a>
                                        </div>
                                        <?php $rotate++; ?>
                                        @ENDFOREACH
                                        <div class="col-12">
                                            <div class="p-3 text-center">
                                                <a href="http://{{ROOT_APP_URL}}/gallery/{{$row['id']}}" class="btn-link font-weight-bold">View all</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--PROFILE-->
							<div class="col-lg-12 col-xl-6 order-lg-3 order-xl-2 tab-content">
                                ...
                                <?php
                                eval('?>'.CodeParser::sting_code(FileReader::read("themes/smartadmin/website_parts/diary.php")));
                                ?>
...
<!-- EDYCJA --->
                    <div class="tab-pane fade {{$profile_edit_active}}" id="profile_edit" role="tab-panel">
								<div id="panel" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            Ustawienia konta <span class="fw-300"><i>{{$row['username']}}</i></span>
                                        </h2>
                                    </div>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <form action="http://{{ROOT_APP_URL}}/changePassword" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="simpleinput" class="form-control" placeholder="{{$row['username']}}">
                                                </div>
												</fieldset><br>
												<div class="form-group">
											...
											<form action="http://{{ROOT_APP_URL}}/changeCredentials" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label class="form-label" for="example-email-2">Email</label>
                                                    <input type="email" id="example-email-2" name="email" class="form-control" placeholder="Email" value="{{$row['email']}}">
                                                </div>											
                                                @IF(FORUM_INSTALLED > 0)
                                                <div class="form-group">
                                                    <label class="form-label" for="example-textarea">Forum Signature</label>
                                                    <textarea class="form-control" id="example-textarea" maxlength="255" rows="5" name="sygnature">{{$usersygnature['content']}}</textarea>
                                                    <a href="#linkToBBcodeInfoPage#" title="What is BB code?"><span class="small">You can use BB code here</span></a>                                   <input type="hidden" name="sygnaturaID" value="{{$usersygnature['id']}}">
                                                </div>
                                                @ENDIF
                                                <div class="form-group">
    ...
    <option value="WF" label="Wallis and Futuna">Wallis and Futuna</option>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <label class="form-label">Flickr Url</label>
