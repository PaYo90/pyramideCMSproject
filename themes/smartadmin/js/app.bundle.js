...
var initApp = (function(app) {
	 ...
	 * usage: initApp.loadScript("themes/smartadmin/js/my_lovely_script.js", myFunction);
		...
		myapp_config.root_
			.on('click touchend', '[data-action]', function(e) {
				...
				switch ( true ) {
					 ...
					 *      data-theme = "themes/smartadmin/css/cust-theme-1.css"
					 **/
					...
					case ( actiontype === 'lang' ):
						...
						//jQuery.getScript('http://url/to/the/script');
							...
							initApp.loadScript("themes/smartadmin/js/i18n/i18n.js", 
