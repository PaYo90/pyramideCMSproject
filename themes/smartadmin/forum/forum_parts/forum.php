											...
											<div class="col-12">
                                                <div class="row no-gutters row-grid align-items-stretch">
                                                    ...
                                                    @$newestPost = \Aplikacja\Forum::newestPost($forum['id'])
                                                    @$countPosts = \Aplikacja\Forum::countAllForumPosts($forum['id'])
                                                    @$countThreads = \Aplikacja\Forum::countAllForumThreads($forum['id'])

                                                    <div class="col-4 col-md-2 col-xl-1 hidden-md-down">
                                                        <div class="p-3 p-md-3">
                                                            <span class="d-block text-muted">{{$countThreads['COUNT(id)']}} <i>Topics</i></span>
                                                            <span class="d-block text-muted">{{$countPosts['COUNT(id)']}} <i>Posts</i></span>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-1 min-width-0">
                                                                    ...
                                                                    <div class="text-muted small text-truncate">
                                                                        data <a href="javascript:void(0)" class="text-info">{{$newestPost['last_post']}}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @ENDIF
