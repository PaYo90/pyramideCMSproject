<div class="tab-pane fade <?=$profile_active;?>" id="profile" role="tab_panel">
        @if($row['diary_perm']==1 OR $row['id']==$_SESSION['user']->id)
                            ...
                            <div class="border-0 flex-1 position-relative shadow-top">
                                ...
                                <div class="pt-2 pb-1 pr-0 pl-0 rounded-0 position-relative" tabindex="-1">
                                    <span class="profile-image rounded-circle d-block position-absolute"
                                          style="background-image:url('http://{{ROOT_APP_URL}}/IMAGES/avatars/<?=$_SESSION["user"]->id;?>/<?=$_SESSION["user"]->username;?>_sm.<?=$_SESSION["user"]->avatar;?>'); background-size: cover;"></span>
                                    <div class="pl-5 ml-5">
            ...
            <div class="card mb-g"><a name="<?=$inscription['id'];?>"></a>
                <div class="card-body pb-0 px-4">
                    <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                        <div class="d-inline-block align-middle <?php echo \Aplikacja\User::checkIfOnline($row['id']); ?> mr-3">
                            <span class="profile-image rounded-circle d-block" style="background-image:url('<?="http://".ROOT_APP_URL."/IMAGES/avatars/".$row['id']."/".$row['username']."_sm.".$row['avatar'];?>'); background-size: cover;"></span>
                        </div>
                    ...
                    <div class="pb-3 pt-2 border-top-0 border-left-0 border-right-0 text-muted">
                        <?php echo \Aplikacja\textInterpreter::bbCode(\Aplikacja\textInterpreter::parse($inscription['content'])); ?>
                    </div>
                            ...
                            foreach ($comments as $comment){
                                ...
                                <div class="d-flex flex-row w-100 py-4">
                                    ...
                                    <div class="mb-0 flex-1 text-dark">
                                        ...
                                        <p class="mb-0">
                                            <?php echo \Aplikacja\textInterpreter::bbCode(
                                            \Aplikacja\textInterpreter::parse($comment['content'])); ?>
                                        </p>
                                        <!--another comment --><!--
