                                ...
                                <div class="col-xl-12">
                                    <h2 class="fs-xxl fw-500 mt-4 text-white text-center">
                                        ...
                                        <small class="h3 fw-300 mt-3 mb-5 text-white opacity-70 hidden-sm-down">
                                            We’ve sent a message to <strong><?=$this->get['email'];?></strong> with a link to activate your account.
                                        </small>
                                    </h2>
                                </div>
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                       <!--
										<div class="alert alert-primary text-dark" role="alert">
                                            <strong>Heads Up!</strong> Some message for activating in admin panel
                                        </div>
										-->
										<?php Aplikacja\Messages::flashMessages(); ?>
                                        <a href="<?="http://".ROOT_APP_URL."/resendEmailActivation?email=".$this->get['email']."&username=".$this->get['username']."&hash=".$this->get['hash'];?>" class="h4">
                                            <i class="fal fa-chevron-right mr-2"></i> Resend e-mail
                                        </a>
                                    </div>
                                </div>
                            </div>
