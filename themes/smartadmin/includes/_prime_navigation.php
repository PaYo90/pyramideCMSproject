<!-- BEGIN Left Aside -->
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">  
                            ...
                            <div class="info-card-text">
                                ...
                                <span class="d-inline-block text-truncate text-truncate-sm">Odwiedzin: xxx</span><!-- odwiedzi, followersow albo zajesestrowan z linku-->
                                <span class="d-inline-block text-truncate text-truncate-sm">Wpłat: xxx</span><!-- odwiedzi, followersow albo zajesestrowan z linku-->
						...
						<ul id="js-nav-menu" class="nav-menu">
							<li <?php if($ActiveMenuCategory=="MAIN"){ echo " class=\"active\""; }?>>
                                ...
                                <ul>
                                    ...
                                    <li<?php if($ActiveMenuSubCategory=="forum"){ echo " class=\"active\""; }?>>
                                        <a href="http://<?=ROOT_APP_URL;?>/forum" title="Forum" data-filter-tags="forum">
                                            <span class="nav-link-text"> - - Forum - -</span>
                                        </a>
                                    </li>
                                    <li<?php if($ActiveMenuSubCategory=="gallery"){ echo " class=\"active\""; }?>>
                                        <a href="http://<?=ROOT_APP_URL;?>/gallery" title="Gallery" data-filter-tags="gallery">
							...
							if($_SESSION['user']->isAdmin()){
								...
								echo '>
									...
									<li>
                               			<a href="http://'.ROOT_APP_URL.'/_NOT_FROM/html_info/intel_analytics_dashboard.html" title="Application Intel" target="_blank">
                    ...
                    <?php
                    if($trycomposed==true){
                        echo '<a href="#" class="btn color-primary-50" data-action="toggle" data-class="layout-composed">Try with Composed Layout</a>';
                    }
                    ?>
                <?php
				...
				?>
                    <?php
                        if(GALLERY_INSTALLED == 1){
                            if($ActiveMenuSubCategory == "gallery"){
                                if(count($albums) > 2){
                                    echo "PRZESTAW ALBUMY"; //TODO: przestaw albumy
                                }
                            }
                        }
                    ?>
