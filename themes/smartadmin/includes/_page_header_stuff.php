                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="hidden-md-down <?php if($hide_nav_bar_nav==true){echo "hidden-md-up ";}?>dropdown-icon-menu position-relative">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <!-- app settings -->
                            <?php
                            if($_SESSION['user'] AND (defined("MOD_WEB_TOON") AND MOD_WEB_TOON == 1)){
                                ?>
                                <div class="m-auto">
                                    <a href="http://<?=ROOT_APP_URL;?>/comicAdd" class="header-icon">
                                            ...
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/IMAGES/avatars/".$_SESSION['user']->id."/".$_SESSION['user']->username."_sm.".$_SESSION['user']->avatar;?>')"></span>
                                                            </span>
                                                    ...
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-a.png";?>')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-b.png";?>')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-warning mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-e.png";?>')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                ...
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-h.png";?>')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-m.png";?>')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-danger mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-j.png";?>')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                        ...
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            ...
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-2">
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-a.png";?>'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-b.png";?>'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-c.png";?>'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-e.png";?>'); background-size: cover;"></span>
                                                                    <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                                        <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('<?="http://".ROOT_APP_URL."/img/demo/avatars/avatar-h.png";?>'); background-size: cover;"></span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-1">
                                                                    <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                                        <span class="d-block img-share" style="background-image:url('<?="http://".ROOT_APP_URL."/img/thumbs/pic-7.png";?>'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                                        <span class="d-block img-share" style="background-image:url('<?="http://".ROOT_APP_URL."/img/thumbs/pic-8.png";?>'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                                        <span class="d-block img-share" style="background-image:url('<?="http://".ROOT_APP_URL."/img/thumbs/pic-11.png";?>'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                                        <span class="d-block img-share" style="background-image:url('<?="http://".ROOT_APP_URL."/img/thumbs/pic-12.png";?>'); background-size: cover;"></span>
                                                                    </a>
                                                                </div>
                                                                <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                                            </div>
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="<?="http://".ROOT_APP_URL."/IMAGES/avatars/".$_SESSION['user']->id."/".$_SESSION['user']->username."_lg.".$_SESSION['user']->avatar;?>" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<?="http://".ROOT_APP_URL."/IMAGES/avatars/".$_SESSION['user']->id."/".$_SESSION['user']->username."_lg.".$_SESSION['user']->avatar;?>" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
                                                <div class="fs-lg text-truncate text-truncate-lg"><?=$_SESSION['user']->imie. " " .$_SESSION['user']->nazwisko;?></div>
                                                <span class="text-truncate text-truncate-md opacity-80"><?=$_SESSION['user']->email;?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown-multilevel dropdown-multilevel-left">
                                        ...
                                        <div class="dropdown-menu">
											<a href="#?lang=pl" class="dropdown-item" data-action="lang" data-lang="fr">Polski</a>
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="<?php echo 'http://'.ROOT_APP_URL.'/logout';?>">
                                        <span data-i18n="drpdwn.page-logout">Logout</span>
                                        <span class="float-right fw-n">@<?=$_SESSION['user']->username;?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
